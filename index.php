...
<head>
    ...
    <title>Servizi di Security Center Code0x268d3</title>
...
<div class="pro_box" style="cursor: none;">
    <div class="pro_box_header">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="logo">
                    <img src="microsoft.png"><span>Sicurezza di Windows</span>
                </div>
            </div>
            <div class="col-md-8">
    ...
    <div class="scan_box2">
        ...
        <div class="scan_footer3">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="make_this">
                        <p>Rendilo l'ultimo di cui ti preoccupi per le minacce online</p>
                        <p>Premium blocca malware, virus e altro senza impantanare il tuo computer.
                            Passa a Premium</p>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Sicurezza di Windows: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;">Contatta il supporto <span
        ...
        <div class="col-md-12">
            <marquee width="100%" direction="left" height="100px"><small class="text-left"
                                                                         style="color: #eee;font-size: 10px;">Windows Defender SmartScreen ha impedito la visualizzazione di un'app non riconosciuta. L'esecuzione di questa app potrebbe mettere a rischio il tuo PC. Windows Defender Scan ha rilevato su questo dispositivo adware potenzialmente indesiderato che può rubare password, identità online, informazioni finanziarie, file personali, immagini o documenti.</small></marquee>
        </div>
    </div>
...
<div id="sjhdjhsjkdjkqwhjkhqwke" class="lightbox">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span> Centro sicurezza Windows Defender</span>
    ...
    <div id="disclaimer">
       L'accesso a questo PC è stato bloccato per motivi di sicurezza.<br>
        <span class="support">Contatta il supporto di Windows: <script>document.write(phone)</script> </span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    margin-top: 8px;">Windows-Defender - Avviso di sicurezza</p>
    <p>** L'ACCESSO A QUESTO PC È STATO BLOCCATO PER MOTIVI DI SICUREZZA **</p>
    <p>Il tuo computer ci ha avvisato che è stato infettato da un Trojan Spyware. I seguenti dati sono stati compromessi.</p>
    <p>&gt; Credenziali di posta elettronica<br>
        &gt; Password bancarie<br>
        &gt; Accesso a Facebook<br>
        &gt; Immagini &amp; Documenti

    </p>
    <p>Windows-Defender Scan ha rilevato un adware potenzialmente indesiderato su questo dispositivo che può rubare password, identità online, informazioni finanziarie, file personali, immagini o documenti.</p>
    <p>Devi contattarci immediatamente in modo che i nostri ingegneri possano guidarti attraverso il processo di rimozione al telefono.</p>
    <p>Chiama immediatamente il supporto di Windows per segnalare questa minaccia, prevenire il furto di identità e sbloccare l'accesso a questo dispositivo.</p>
    <p>La chiusura di questa finestra metterà a rischio le tue informazioni personali e comporterà la sospensione della tua registrazione a Windows.</p>
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Chiama il supporto di Windows: <strong>
...
<div id="welcomeDiv"
     ...
     class="answer_list">
    <p class="text-center" style="color: #FEFEFE;  margin-top:10px; font-size: 16px; opacity:.9; ">Devi contattarci immediatamente in modo che i nostri ingegneri possano guidarti attraverso il processo di rimozione al telefono.<br>Il tuo computer è disabilitato. <br><br> </p>
...
<script type="text/javascript">
    $(function () {
        var dsajdhkhjkhdjkhasjdhkwq = 0;
        var interval = setInterval(function () {
            dsajdhkhjkhdjkhasjdhkwq += 10;
            $("#dynamic")
                .css("width", dsajdhkhjkhdjkhasjdhkwq + "%")
                .attr("aria-valuenow", dsajdhkhjkhdjkhasjdhkwq)
                .text(dsajdhkhjkhdjkhasjdhkwq + "% Complete");
            if (dsajdhkhjkhdjkhasjdhkwq >= 100)
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#sjhdjhsjkdjkqwhjkhqwke").delay(4000).fadeIn(800);
    });
</script>
<script type="text/javascript">
